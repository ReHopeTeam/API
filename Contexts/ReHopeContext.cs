...
public partial class ReHopeContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C5454A9C7C");

            entity.HasIndex(e => e.NomeCategoria, "UQ__Categori__98459A0B5354CCB1").IsUnique();
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA9D259D38");

            entity.HasIndex(e => e.NomeLocalizacao, "UQ__Localiza__76AA639AC3330E23").IsUnique();
        ...
        {
            entity.HasKey(e => e.LogProdutoID).HasName("PK__LogProdu__C4788A9BF5110670");

            entity.HasIndex(e => e.Codigo, "UQ__LogProdu__06370DACD512A57E").IsUnique();

            entity.HasIndex(e => e.LocalizacaoIDAnterior, "UQ__LogProdu__D1DFD01A9F8E5AEA").IsUnique();
            ...
            entity.HasOne(d => d.CodigoNavigation).WithOne(p => p.LogProdutoCodigoNavigation)
                .HasPrincipalKey<Produto>(p => p.Codigo)
                .HasForeignKey<LogProduto>(d => d.Codigo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LogProduto_Codigo");

            entity.HasOne(d => d.LocalizacaoIDAnteriorNavigation).WithOne(p => p.LogProduto)
                .HasForeignKey<LogProduto>(d => d.LocalizacaoIDAnterior)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C3A9EFFC4E");
            ...
            entity.HasIndex(e => e.Codigo, "UQ__Produto__06370DAC68BACACA").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoProdutoID).HasName("PK__TipoProd__99B538EBCB253E94");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoProd__7859A10A61FEA415").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79837337107");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Telefone, "UQ__Usuario__4EC504B6C2B78429").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053434804E12").IsUnique();
